...
# 2. 复制模板
Copy-Item (Join-Path $here 'note-data.json')    (Join-Path $dir 'note-data.json')    -Force
Copy-Item (Join-Path $here '01-商业模式建立.md') (Join-Path $dir '01-商业模式建立.md') -Force
Copy-Item (Join-Path $here '02-运营面板.md')     (Join-Path $dir '02-运营面板.md')     -Force
Copy-Item (Join-Path $here 'README-项目.md')     (Join-Path $dir 'README.md')          -Force
...
Write-Host "   ② 手动打开《01-商业模式建立.md》填写"
Write-Host ""
